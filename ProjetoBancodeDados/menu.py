...
def menu(id_usuario, tipo_usuario):
    while True:
        ...
        if tipo_usuario == "admin":
            if opcao == "1":
                inserirUsuario(tipo_usuario)
            elif opcao == "2":
                listarUsuarios()
            elif opcao == "3":
                excluirUsuario(tipo_usuario, tipo_usuario)
            elif opcao == "4":
                inserirFilmeSerie()
            elif opcao == "5":
                excluirFilmeSerie()
                ...
                inserirHistorico(id_usuario, tipo_usuario)
            elif opcao == "11":
                listarHistorico(id_usuario, tipo_usuario)
            elif opcao == "12":
                excluirHistorico(id_usuario, tipo_usuario)
            elif opcao == "13":
                inserirRecomendacao(id_usuario, tipo_usuario)
            elif opcao == "14":
                listarRecomendacoes()
            elif opcao == "15":
                excluirRecomendacao(id_usuario, tipo_usuario)
            elif opcao == "0":
            ...
            if opcao == "1":
                ...
                excluirUsuario(id_usuario, tipo_usuario)
                break
            elif opcao == "0":
                print("Saindo do menu e voltando para o login...")
                break
